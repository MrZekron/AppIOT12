...
// Pantalla que muestra los datos de transferencia y permite enviar comprobante por WhatsApp.
...
public class CentroPagos extends AppCompatActivity {
    ...
    // Datos de la compra recibidos por Intent.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lee datos enviados desde la pantalla anterior.
        leerExtras();

        // Valida que existan datos mínimos.
        ...
        // Muestra la información de pago.
        cargarDatosPantalla();

        // Envía al usuario a WhatsApp.
    ...
    // Lee extras recibidos por Intent.
    ...
    // Carga los datos de compra y transferencia en pantalla.
    ...
    // Abre WhatsApp con un mensaje automático y actualiza el estado de la compra.
    ...
    // Cambia el estado de la compra para revisión del administrador.
    ...
    // Muestra un mensaje rápido en pantalla.
